 ...
 * 
 * @Configuration public class RedisAutoConfig {
 * @Bean public RedisTemplate<Object, Object>
	...
	public int updateDataByGlobalTxId(String globalTxId, Map<String, Object> data) throws Exception {
		...
		return (Integer) redisTemplate.execute(new RedisCallback() {
			public Object doInRedis(RedisConnection connection) throws DataAccessException {
				...
				for (byte[] bs : collection) {
					try {
						DistributedTransactionContext context = (DistributedTransactionContext) serializer
								.deserialize(bs);
						if (status != null) {
